...
<div class="l-paper">
	...
	<div id="area-3" class="page l-container">
		...
		<ul class="menu-lists">
			...
			<li class="menu-list">
				<a href="#menu3">メニュー３</a>
			</li>
			<li class="menu-list">
				<a href="#menu4">メニュー4</a>
			</li>
		</ul>
		...
		<div class="page-menu pd-btm">
			...
			<div class="display-f">
				<div id="menu3" class="page-menu-secbox">
					<div class="page-menu-secbox__pic">
						<img src="<?php echo get_template_directory_uri(); ?>/images/pic/sample-pic.png" alt="メニュー１">
						<h3 class="page-menu-secbox__pic__title">整体矯正</h3>
					</div>
				...
				<div id="menu4" class="page-menu-secbox">
					<div class="page-menu-secbox__pic">
						<img src="<?php echo get_template_directory_uri(); ?>/images/pic/sample-pic.png" alt="メニュー１">
						<h3 class="page-menu-secbox__pic__title">整体矯正</h3>
					</div>
